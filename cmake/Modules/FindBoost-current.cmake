## 04/30/2014 mallan: FindBoost.cmake from cmake 2.8.12
##
## 01/18/2013 mallan: default to looking for boost in IRG 
##            packages directory so we don't have to set env
##            vars. If not found there, the other system paths
##            will still be searched
## 01/16/2013 mallan: added NO_CMAKE_SYSTEM_PATH to find_library 
##            command because it insisted on picking up the system 
##            libraries no matter what BOOST_ROOT was set to (at
##            around line 733)
######################################################################
  ...
  if(UNIX AND NOT CYGWIN)
    ...
    if(_using_boost_thread GREATER -1)
      ...
      if(BOOST_THREAD_LIBRARY)
        ...
        set_property(TARGET pthread PROPERTY IMPORTED_LOCATION "${BOOST_THREAD_LIBRARY}" )
        set(${_outvar} ${ARGN} pthread PARENT_SCOPE)
      endif()
    endif()
  endif()
endfunction()
...
if(Boost_FOUND)
  ...
  foreach( COMPONENT  ${Boost_FIND_COMPONENTS} )
    ...
    if( Boost_${UPPERCOMPONENT}_FOUND )
      ...
      set_property(TARGET boost_${COMPONENT} PROPERTY IMPORTED_LOCATION "${Boost_${UPPERCOMPONENT}_LIBRARY}" )
      set_property(TARGET boost_${COMPONENT} PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${Boost_INCLUDE_DIR}")
